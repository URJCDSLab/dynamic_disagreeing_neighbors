...
from dynamic_disagreeing_neighbors.utils import named_scorer, get_store_name, NpEncoder, gps_score
...
for experiment in [
 ...
 'vehicle2'
    ...
    score = named_scorer(gps_score, 'gps_score', greater_is_better=True)
